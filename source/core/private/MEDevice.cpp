...
void MEDevice::CopyBufferToImage(VkBuffer buffer,VkImage image, uint32_t width, uint32_t height)
{
    VkCommandBuffer commandBuffer = commandPool->BeginSingleTimeCommands();
...
void MEDevice::CreateTextureSampler(VkSampler& sampler, uint32_t mipLevels)
{
...
void MEDevice::GenerateMipmaps(VkImage image,VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels)
{
